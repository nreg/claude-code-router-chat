...
## Overview
Added a settings interface to the Claude Code Router Chat webview that allows users to configure WSL settings.
...
2. Open Claude Code Router Chat (Ctrl+Shift+C)
