		...
		marked.use({
			...
			renderer: {
				code(code, language) {
					...
					const svgIcon = '<svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/></svg>';
					
					return '<div class="code-block-container">' +
						'<div class="code-block-header">' +
							'<span class="code-block-language">' + lang + '</span>' +
							'<button class="code-copy-btn" onclick="copyCodeBlock(\\'' + codeId + '\\')" title="Copy code">' +
								svgIcon +
							'</button>' +
						'</div>' +
						'<pre class="code-block"><code class="language-' + lang + '" id="' + codeId + '" data-raw-code="' + escapedCode + '">' + code + '</code></pre>' +
					'</div>';
				}
			},
